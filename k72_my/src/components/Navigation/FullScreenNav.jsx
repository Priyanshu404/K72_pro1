...
const FullScreenNav = () => {
  ...
  return (
    <div
      ref={fullScreenRef}
      id="fullscreennav"
      className="fullscreennav hidden text-white overflow-y-auto h-screen w-full z-50 absolute"
    >
      ...
      <div ref={fullNavLinksRef} className="relative">
        ...
        <div className="py-36 min-h-full overflow-y-auto">
          <div className="link origin-top relative border-t-1 border-white">
            <h1 className="font-[font2] text-5xl lg:text-[8vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase">
              Projets
            </h1>
            <div className="moveLink absolute text-black flex top-0 bg-[#D3FD50] min-w-max overflow-x-auto">
